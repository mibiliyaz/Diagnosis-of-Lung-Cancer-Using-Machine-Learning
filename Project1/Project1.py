# https://www.youtube.com/watch?v=Cf1F624tU-s
...
dataset = pd.read_csv("./Dataset/LungCancer.csv")
...
print("Position 1.2 shows the patients that have higher risk of Cancer, In this case = 1")
